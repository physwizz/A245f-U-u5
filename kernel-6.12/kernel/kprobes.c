...
void __weak *alloc_insn_page(void)
{
	 ...
	 */
	void *p = execmem_alloc(EXECMEM_KPROBES, PAGE_SIZE);

#ifdef CONFIG_RKP
	uh_call(UH_APP_RKP, RKP_KPROBE_PAGE, (u64)p, PAGE_SIZE, 0, 0);
#endif
	return p;
}
...
{
#ifdef CONFIG_RKP
	uh_call(UH_APP_RKP, RKP_KPROBE_PAGE, (u64)page, PAGE_SIZE, 1, 0);
#endif
	execmem_free(page);
}
