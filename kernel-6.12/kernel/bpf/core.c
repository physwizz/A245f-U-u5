...
#ifdef CONFIG_RKP
	uh_call(UH_APP_RKP, RKP_BPF_LOAD, (u64)ro_header, (u64)size, 0, 0);
#endif
	return ro_header;
}
...
#ifdef CONFIG_RKP
	uh_call(UH_APP_RKP, RKP_BPF_LOAD, (u64)ro_header, ro_header->size, 0, 0);
#endif
	kvfree(rw_header);

	if (IS_ERR(ptr)) {
#ifdef CONFIG_RKP
		uh_call(UH_APP_RKP, RKP_BPF_LOAD, (u64)ro_header, ro_header->size, 1, 0);
#endif
