...
static bool disable_pcp_high_max __read_mostly = false;

static int __init disable_pcp_high_max_setup(char *str)
{
	disable_pcp_high_max = true;
	return 1;
}
__setup("disable_pcp_high_max", disable_pcp_high_max_setup);
...
static void zone_set_pageset_high_and_batch(struct zone *zone, int cpu_online)
{
	...
	if (percpu_pagelist_high_fraction || disable_pcp_high_max) {
