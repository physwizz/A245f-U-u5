...
static int input_dev_suspend(struct device *dev)
{
	...
	/* Don't turn off LEDs when BT device suspend. P250922-08572 */
	if (input_dev->id.bustype != BUS_BLUETOOTH)
...
static int input_dev_resume(struct device *dev)
{
	...
	/* No need restore state of LEDs when BT device resume. P250922-08572 */
	if (input_dev->id.bustype != BUS_BLUETOOTH)
