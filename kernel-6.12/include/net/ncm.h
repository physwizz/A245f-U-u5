...
#define isIpv4AddressEqualsNull(srcaddr, dstaddr) \
	((((strcmp(srcaddr, "0.0.0.0")) || (strcmp(dstaddr, "0.0.0.0"))) == 0) ? 1 : 0)
#define isIpv6AddressEqualsNull(srcaddr, dstaddr)                                \
	((((strcmp(srcaddr, "0000:0000:0000:0000:0000:0000:0000:0000")) ||       \
	   (strcmp(dstaddr, "0000:0000:0000:0000:0000:0000:0000:0000"))) == 0) ? \
		       1 : 0)
...
extern void collect_udp_start_flow_metadata(struct sock *sk, struct sk_buff *skb);
...
#define NCM_DEBUG 1
#if NCM_DEBUG
#define NCM_LOGD(...) pr_info("ncm: " __VA_ARGS__)
#else
#define NCM_LOGD(...)
#endif /* NCM_DEBUG */
#define NCM_LOGE(...) pr_err("ncm: " __VA_ARGS__)
