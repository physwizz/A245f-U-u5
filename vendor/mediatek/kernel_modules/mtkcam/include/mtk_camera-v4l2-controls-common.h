...
#define V4L2_CID_MTK_SENSOR_WRITE_MODE_SETTING \
	(V4L2_CID_USER_MTK_SENSOR_BASE + 46)
...
#define V4L2_CMD_G_SENSOR_CONNECTOR_STATUS \
	(V4L2_CMD_USER_MTK_SENSOR_BASE + 29)

#define V4L2_CMD_G_INSERTION_LOSS_PARAM \
	(V4L2_CMD_USER_MTK_SENSOR_BASE + 30)

#define V4L2_CMD_G_CUST_CTLE_CONFIG \
	(V4L2_CMD_USER_MTK_SENSOR_BASE + 31)

#define V4L2_CMD_SET_MIPI_ERR_CNT \
	(V4L2_CMD_USER_MTK_SENSOR_BASE + 32)
