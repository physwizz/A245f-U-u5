...
#define DRV_LOG_MORE(ctx, format, args...) do { \
	struct v4l2_subdev *_sd = NULL; \
	struct adaptor_ctx *_adaptor_ctx = NULL; \
	if (ctx->i2c_client) \
		_sd = i2c_get_clientdata(ctx->i2c_client); \
...
void set_max_framerate_base100(struct subdrv_ctx *ctx,
...
void set_dcg_vs_multi_shutter_frame_length_in_lut(struct subdrv_ctx *ctx,
		u64 *shutters, u16 shutter_cnt,	u64 frame_time_us, u32 *frame_length_in_lut);
