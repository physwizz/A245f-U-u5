...
static __maybe_unused struct dma_debug_item dbg_CQI_R1[] = {
	{0x00000078, "cqi_r1 32(hex) 0000"},
	{0x00000178, "cqi_r1 state_checksum"},
	{0x00000278, "cqi_r1 line_pix_cnt_tmp"},
	{0x00000378, "cqi_r1 line_pix_cnt"},
	{0x00000578, "cqi_r1 smi_debug_data (case 0)"},
	{0x00010678, "cqi_r1 aff(fifo)_debug_data (case 1)"},
	{0x00030678, "cqi_r1 aff(fifo)_debug_data (case 3)"},
	{0x00000A78, "cqi_r1 ufo_state_checksum"},
	{0x00000B78, "cqi_r1 ufo_line_pix_cnt_tmp"},
	{0x00000C78, "cqi_r1 ufo_line_pix_cnt"},
};
static __maybe_unused struct dma_debug_item dbg_CQI_R2[] = {
	{0x00000079, "cqi_r2 32(hex) 0000"},
	{0x00000179, "cqi_r2 state_checksum"},
	{0x00000279, "cqi_r2 line_pix_cnt_tmp"},
	{0x00000379, "cqi_r2 line_pix_cnt"},
	{0x00000579, "cqi_r2 smi_debug_data (case 0)"},
	{0x00010679, "cqi_r2 aff(fifo)_debug_data (case 1)"},
	{0x00030679, "cqi_r2 aff(fifo)_debug_data (case 3)"},
	{0x00000A79, "cqi_r2 ufo_state_checksum"},
	{0x00000B79, "cqi_r2 ufo_line_pix_cnt_tmp"},
	{0x00000C79, "cqi_r2 ufo_line_pix_cnt"},
};
static __maybe_unused struct dma_debug_item dbg_CQI_R3[] = {
	{0x000000A0, "cqi_r3 32(hex) 0000"},
	{0x000001A0, "cqi_r3 state_checksum"},
	{0x000002A0, "cqi_r3 line_pix_cnt_tmp"},
	{0x000003A0, "cqi_r3 line_pix_cnt"},
	{0x000005A0, "cqi_r3 smi_debug_data (case 0)"},
	{0x000106A0, "cqi_r3 aff(fifo)_debug_data (case 1)"},
	{0x000306A0, "cqi_r3 aff(fifo)_debug_data (case 3)"},
	{0x00000AA0, "cqi_r3 ufo_state_checksum"},
	{0x00000BA0, "cqi_r3 ufo_line_pix_cnt_tmp"},
	{0x00000CA0, "cqi_r3 ufo_line_pix_cnt"},
};
static __maybe_unused struct dma_debug_item dbg_CQI_R4[] = {
	{0x000000A1, "cqi_r4 32(hex) 0000"},
	{0x000001A1, "cqi_r4 state_checksum"},
	{0x000002A1, "cqi_r4 line_pix_cnt_tmp"},
	{0x000003A1, "cqi_r4 line_pix_cnt"},
	{0x000005A1, "cqi_r4 smi_debug_data (case 0)"},
	{0x000106A1, "cqi_r4 aff(fifo)_debug_data (case 1)"},
	{0x000306A1, "cqi_r4 aff(fifo)_debug_data (case 3)"},
	{0x00000AA1, "cqi_r4 ufo_state_checksum"},
	{0x00000BA1, "cqi_r4 ufo_line_pix_cnt_tmp"},
	{0x00000CA1, "cqi_r4 ufo_line_pix_cnt"},
};
...
static __maybe_unused struct dma_debug_item dbg_RAWI_R2[] = {
	{0x00000008, "rawi_r2 32(hex) 0000"},
	{0x00000108, "rawi_r2 state_checksum"},
	{0x00000208, "rawi_r2 line_pix_cnt_tmp"},
	{0x00000308, "rawi_r2 line_pix_cnt"},
	{0x00000508, "rawi_r2 smi_debug_data (case 0)"},
	{0x00010608, "rawi_r2 aff(fifo)_debug_data (case 1)"},
	{0x00030608, "rawi_r2 aff(fifo)_debug_data (case 3)"},
	{0x00000A08, "rawi_r2 ufo_state_checksum"},
	{0x00000B08, "rawi_r2 ufo_line_pix_cnt_tmp"},
	{0x00000C08, "rawi_r2 ufo_line_pix_cnt"},
};
static __maybe_unused struct dma_debug_item dbg_UFDI_R2[] = {
	{0x00000009, "ufdi_r2 32(hex) 0000"},
	{0x00000109, "ufdi_r2 state_checksum"},
	{0x00000209, "ufdi_r2 line_pix_cnt_tmp"},
	{0x00000309, "ufdi_r2 line_pix_cnt"},
	{0x00000509, "ufdi_r2 smi_debug_data (case 0)"},
	{0x00010609, "ufdi_r2 aff(fifo)_debug_data (case 1)"},
	{0x00030609, "ufdi_r2 aff(fifo)_debug_data (case 3)"},
	{0x00000A09, "ufdi_r2 ufo_state_checksum"},
	{0x00000B09, "ufdi_r2 ufo_line_pix_cnt_tmp"},
	{0x00000C09, "ufdi_r2 ufo_line_pix_cnt"},
};
static __maybe_unused struct dma_debug_item dbg_RAWI_R5[] = {
	...
	{0x00000A0C, "rawi_r5 ufo_state_checksum"},
	{0x00000B0C, "rawi_r5 ufo_line_pix_cnt_tmp"},
	{0x00000C0C, "rawi_r5 ufo_line_pix_cnt"},
};
static __maybe_unused struct dma_debug_item dbg_UFDI_R5[] = {
	{0x0000000D, "ufdi_r5 32(hex) 0000"},
	{0x0000010D, "ufdi_r5 state_checksum"},
	{0x0000020D, "ufdi_r5 line_pix_cnt_tmp"},
	{0x0000030D, "ufdi_r5 line_pix_cnt"},
	{0x0000050D, "ufdi_r5 smi_debug_data (case 0)"},
	{0x0001060D, "ufdi_r5 aff(fifo)_debug_data (case 1)"},
	{0x0003060D, "ufdi_r5 aff(fifo)_debug_data (case 3)"},
	{0x00000A0D, "ufdi_r5 ufo_state_checksum"},
	{0x00000B0D, "ufdi_r5 ufo_line_pix_cnt_tmp"},
...
static __maybe_unused struct dma_debug_item dbg_YUVO_R1[] = {
	...
	{0x000000AD,
	 "yuvo_r1_smi_port / plane-0 (i.e. yuvo_r1) / { len-cnt, dle-cnt }"},
	{0x000000AE,
	 "yuvo_r1_smi_port / plane-0 (i.e. yuvo_r1) / { load_com-cnt, bvalid-cnt }"},
	{0x000000AF,
	 "yuvo_r1_smi_port / plane-1 (i.e. yuvbo_r1) / { len-cnt, dle-cnt }"},
	{0x000000B0,
	 "yuvo_r1_smi_port / plane-1 (i.e. yuvbo_r1) / { load_com-cnt, bvalid-cnt }"},
	{0x000000C0,
...
static __maybe_unused struct dma_debug_item dbg_YUVO_R3[] = {
	...
	{0x000000B1,
	 "yuvo_r3_smi_port / plane-0 (i.e. yuvo_r3) / { len-cnt, dle-cnt }"},
	{0x000000B2,
	 "yuvo_r3_smi_port / plane-0 (i.e. yuvo_r3) / { load_com-cnt, bvalid-cnt }"},
	{0x000000B3,
	 "yuvo_r3_smi_port / plane-1 (i.e. yuvbo_r3) / { len-cnt, dle-cnt }"},
	{0x000000B4,
	 "yuvo_r3_smi_port / plane-1 (i.e. yuvbo_r3) / { load_com-cnt, bvalid-cnt }"},
	{0x000002C0,
...
// M4U_PORT CAM3_YUVO_R2 : yuvo_r2 + yuvbo_r2 + yuvo_r4 + yuvbo_r4 + yuvo_r5 +
// yuvbo_r5
...
static __maybe_unused struct dma_debug_item dbg_RZH1N2TO_R2[] = {
	...
	{0x01000050,
	 "rzh1n2to_r1_smi_port / plane-2 (i.e. rzh1n2to_r2) / data-crc"},
	{0x00000084, "rzh1n2to_r1_smi_port / smi_latency_mon output"},
	{0x000010C0,
...
static __maybe_unused struct dma_debug_item dbg_RZH1N2TO_R3[] = {
	...
	{0x01000051,
	 "rzh1n2to_r1_smi_port / plane-3 (i.e. rzh1n2to_r3) / data-crc"},
	{0x01000052,
	 "rzh1n2to_r1_smi_port / plane-4 (i.e. rzh1n2tbo_r3) / data-crc"},
	{0x00000084, "rzh1n2to_r1_smi_port / smi_latency_mon output"},
	{0x000011C0,
...
// M4U_PORT CAM3_DRZS4NO_R1 : drzs4no_r1 + drzs4no_r2 + drzs4no_r3 + lmvo_r1 +
// actso_r1
static __maybe_unused struct dma_debug_item dbg_DRZS4NO_R1[] = {
	...
	{0x01000053,
	 "drzs4no_r1_smi_port / plane-0 (i.e. drzs4no_r1) / data-crc"},
...
static __maybe_unused struct dma_debug_item dbg_DRZS4NO_R2[] = {
	...
	{0x01000054,
	 "drzs4no_r1_smi_port / plane-1 (i.e. drzs4no_r2) / data-crc"},
	{0x00000085, "drzs4no_r1_smi_port / smi_latency_mon output"},
	{0x000014C0,
...
static __maybe_unused struct dma_debug_item dbg_DRZS4NO_R3[] = {
	...
	{0x01000055,
	 "drzs4no_r1_smi_port / plane-2 (i.e. drzs4no_r3) / data-crc"},
	{0x00000085, "drzs4no_r1_smi_port / smi_latency_mon output"},
	{0x000015C0,
...
static __maybe_unused struct dma_debug_item dbg_ACTSO_R1[] = {
	...
	{0x01000057,
	 "drzs4no_r1_smi_port / plane-4 (i.e. actso_r1) / data-crc"},
	{0x00000085, "drzs4no_r1_smi_port / smi_latency_mon output"},
	{0x000017C0,
...
static __maybe_unused struct dma_debug_item dbg_ori_cmd_cnt[] = {
	{0x000000A0,
	 "rawi_r2_smi_port / plane-0 (i.e. rawi_r2) / { len-cnt, dle-cnt }"},
	{0x000000A1,
	 "ufdi_r2_smi_port / plane-0 (i.e. ufdi_r2) / { len-cnt, dle-cnt }"},
	{0x000000A2,
	 "rawi_r3_smi_port / plane-0 (i.e. rawi_r3) / { len-cnt, dle-cnt }"},
	{0x000000A3,
	 "ufdi_r3_smi_port / plane-0 (i.e. ufdi_r3) / { len-cnt, dle-cnt }"},
	{0x000000A4,
	 "rawi_r4_smi_port / plane-0 (i.e. rawi_r4) / { len-cnt, dle-cnt }"},
	{0x000000A5,
	 "rawi_r5_smi_port / plane-0 (i.e. rawi_r5) / { len-cnt, dle-cnt }"},
	{0x000000A6,
	 "cqi_r1_smi_port / plane-0 (i.e. cqi_r1) / { len-cnt, dle-cnt }"},
	{0x000000A7,
	 "cqi_r1_smi_port / plane-1 (i.e. cqi_r3) / { len-cnt, dle-cnt }"},
	{0x000000A8,
	 "cqi_r2_smi_port / plane-0 (i.e. cqi_r2) / { len-cnt, dle-cnt }"},
	{0x000000A9,
	 "cqi_r2_smi_port / plane-1 (i.e. cqi_r4) / { len-cnt, dle-cnt }"},
	{0x000000AA,
	 "lsci_r1_smi_port / plane-0 (i.e. lsci_r1) / { len-cnt, dle-cnt }"},
	{0x000000AB,
	 "imgo_r1_smi_port / plane-0 (i.e. imgo_r1) / { len-cnt, dle-cnt }"},
	{0x000000AC,
	 "imgo_r1_smi_port / plane-0 (i.e. imgo_r1) / { load_com-cnt, bvalid-cnt }"},
	{0x000000AD,
	 "fho_r1_smi_port / plane-0 (i.e. fho_r1) / { len-cnt, dle-cnt }"},
	{0x000000AE,
	 "fho_r1_smi_port / plane-0 (i.e. fho_r1) / { load_com-cnt, bvalid-cnt }"},
	{0x000000AF,
	 "fho_r1_smi_port / plane-1 (i.e. aaho_r1) / { len-cnt, dle-cnt }"},
	{0x000000B0,
	 "fho_r1_smi_port / plane-1 (i.e. aaho_r1) / { load_com-cnt, bvalid-cnt }"},
	{0x000000B1,
	 "fho_r1_smi_port / plane-2 (i.e. pdo_r1) / { len-cnt, dle-cnt }"},
	{0x000000B2,
	 "fho_r1_smi_port / plane-2 (i.e. pdo_r1) / { load_com-cnt, bvalid-cnt }"},
	{0x000000B3,
	 "aao_r1_smi_port / plane-0 (i.e. aao_r1) / { len-cnt, dle-cnt }"},
	{0x000000B4,
	 "aao_r1_smi_port / plane-0 (i.e. aao_r1) / { load_com-cnt, bvalid-cnt }"},
	{0x000000B5,
	 "aao_r1_smi_port / plane-1 (i.e. afo_r1) / { len-cnt, dle-cnt }"},
	{0x000000B6,
	 "aao_r1_smi_port / plane-1 (i.e. afo_r1) / { load_com-cnt, bvalid-cnt }"},
	{0x000000B7,
	 "ufdi_r5_smi_port / plane-0 (i.e. ufdi_r5) / { len-cnt, dle-cnt }"},
};
