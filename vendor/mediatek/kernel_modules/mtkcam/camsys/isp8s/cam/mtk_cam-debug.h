...
#define MSG_COMPOSE_TIMEOUT "Camsys: CQ compose timeout"
#define MSG_DEQUE_ERROR		"Camsys: No P1 done"
#define MSG_TG_OVERRUN		"[TRACE_TOP] Camsys: TG Overrun Err"
...
#define MSG_CAMSV_ERROR		"[TRACE_TOP] Camsv: camsv error"
#define MSG_CAMSV_SEAMLESS_ERROR	"[TRACE_TOP] Camsys: camsv seamless error"
