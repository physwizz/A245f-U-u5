...
cd kernel-5.10
python scripts/gen_build_config.py --kernel-defconfig a24_defconfig --kernel-defconfig-overlays "entry_level.config" -m user -o ../out/target/product/a24/obj/KERNEL_OBJ/build.config
