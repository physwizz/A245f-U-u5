...
/* CHG register */
#define S2MF301_CHG_QBAT_OFF		0x36
...
enum cam_flash_mode {
	...
	CAM_FLASH_MODE_FLASH,		//CAM2_FLASH_MODE_FLASH,
	CAM_FLASH_MODE_TORCH,		//CAM2_FLASH_MODE_TORCH,
	CAM_FLASH_MODE_PREFLASH,	//CAM2_FLASH_MODE_PREFLASH,
};
...
enum s2mf301_fled_mode {
	...
	S2MF301_FLED_MODE_PREFLASH,
	S2MF301_FLED_MODE_FACTORY,
	S2MF301_FLED_MODE_SHUTDOWN_OFF,
	S2MF301_FLED_MODE_MAX,
};

enum flash_chg_voltage {
	FLASH_CHG_VOLTAGE_NOT_SET,
	FLASH_CHG_VOLTAGE_NORMAL,
	FLASH_CHG_VOLTAGE_HIGH
};

enum s2mf301_volt_direction{
	VOLTAGE_DECREASE,
	VOLTAGE_INCREASE
};
