...
static const struct snd_pcm_hardware mt6789_hostless_hardware = {
				    ...
				    struct snd_soc_dai *dai)
{
	...
	snd_soc_set_runtime_hwparams(substream, &mt6789_hostless_hardware);
...
static struct snd_soc_dai_driver mtk_dai_hostless_driver[] = {
	...
	{
		.name = "Hostless_FM_Record DAI",
		.id = MT6789_DAI_HOSTLESS_FM_RECORD,
		.capture = {
	...
	},
	{
		...
		.id = MT6789_DAI_HOSTLESS_SPH_ECHO_REF,
		.playback = {
	...
	},
	{
		...
		.id = MT6789_DAI_HOSTLESS_SPK_INIT,
		.playback = {
	...
	},
	{
		...
		.id = MT6789_DAI_HOSTLESS_IMPEDANCE,
		.playback = {
	...
	},
	{
		...
		.id = MT6789_DAI_HOSTLESS_ADDA_DL_HWGain,
		.playback = {
	...
	},
	{
		...
		.id = MT6789_DAI_HOSTLESS_SRC_BARGEIN,
		.playback = {
	...
	},
	{
		...
		.id = MT6789_DAI_HOSTLESS_HW_GAIN_AAUDIO,
		.capture = {
	...
	},
	{
		...
		.id = MT6789_DAI_HOSTLESS_SRC_AAUDIO,
		.playback = {
