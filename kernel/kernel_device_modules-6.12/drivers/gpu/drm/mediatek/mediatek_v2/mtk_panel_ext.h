...
//Custom DDIC CMD data structure for Titan projects which need to TX 510 bytes
//Titan Customer should use below data structure to send large DDIC CMD at once
struct mtk_panel_para_table_titan {
	u32 count;
	u8 para_list[510];
};
