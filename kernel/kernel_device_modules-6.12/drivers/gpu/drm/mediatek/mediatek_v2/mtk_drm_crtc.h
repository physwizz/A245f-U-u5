...
#define DBG_DSI_NUM 6
#define DBG_DSI_TOTAL_NUM 20
...
#define DISP_SLOT_READ_DDIC_V2_BASE_END (DISP_SLOT_READ_DDIC_V2_BASE + READ_DDIC_SLOT_V2_NUM * 0x4)

#define DISP_SLOT_READ_DSI_DBG_BASE	DISP_SLOT_READ_DDIC_V2_BASE_END
#define DISP_SLOT_READ_DSI_DBG_END (DISP_SLOT_READ_DSI_DBG_BASE + DBG_DSI_TOTAL_NUM * 0x4)

#define DISP_SLOT_DSI_RX_TRIG_STA	(DISP_SLOT_READ_DSI_DBG_END)
...
#define DISP_SLOT_DBI_IR_DROP_STAT_R (DISP_SLOT_DBI_COUNT_ERROR + 0x4)
#define DISP_SLOT_DBI_IR_DROP_STAT_G (DISP_SLOT_DBI_IR_DROP_STAT_R + 0x4)
#define DISP_SLOT_DBI_IR_DROP_STAT_B (DISP_SLOT_DBI_IR_DROP_STAT_G + 0x4)
#define DISP_SLOT_DBI_IR_DROP_SQUA_R_0 (DISP_SLOT_DBI_IR_DROP_STAT_B + 0x4)
#define DISP_SLOT_DBI_IR_DROP_SQUA_R_1 (DISP_SLOT_DBI_IR_DROP_SQUA_R_0 + 0x4)
#define DISP_SLOT_DBI_IR_DROP_SQUA_G_0 (DISP_SLOT_DBI_IR_DROP_SQUA_R_1 + 0x4)
#define DISP_SLOT_DBI_IR_DROP_SQUA_G_1 (DISP_SLOT_DBI_IR_DROP_SQUA_G_0 + 0x4)
#define DISP_SLOT_DBI_IR_DROP_SQUA_B_0 (DISP_SLOT_DBI_IR_DROP_SQUA_G_1 + 0x4)
#define DISP_SLOT_DBI_IR_DROP_SQUA_B_1 (DISP_SLOT_DBI_IR_DROP_SQUA_B_0 + 0x4)
#define DISP_SLOT_DBI_IR_DROP_CHECK_SUM (DISP_SLOT_DBI_IR_DROP_SQUA_B_1 + 0x4)
#define DISP_SLOT_DBI_COUNT_SW_TRIGGER (DISP_SLOT_DBI_IR_DROP_CHECK_SUM + 0x4)
#define DISP_SLOT_TRIGGER_LOOP_SKIP_MERGE (DISP_SLOT_DBI_COUNT_SW_TRIGGER + 0x4)
#define DISP_SLOT_CUR_HRT_VAL_DBI_COUNT (DISP_SLOT_TRIGGER_LOOP_SKIP_MERGE + 0x4)

/* For idlemgr by wb*/
#define DISP_SLOT_IDLEMGR_BY_WB_STATUS (DISP_SLOT_CUR_HRT_VAL_DBI_COUNT + 0x4)
...
/* For dsi status debug */
#define DISP_SLOT_DSI_DEBUG_STATUS  (DISP_SLOT_IDLEMGR_BY_WB_BREAK + 0x4)

/* reset OVL log */
#define OVL_RT_LOG_NR 10
#define DISP_SLOT_OVL_COMP_ID(n) (DISP_SLOT_DSI_DEBUG_STATUS + 0x4 + (0x4 * (n)))
...
struct mtk_drm_crtc {
	...
	enum mtk_ddp_comp_id bypass_bld_id;
	enum mtk_ddp_comp_id pre_bld_id;
