...
/* mt6993 dl cwb */
static const int disp_wdma1_dl_path[] = {
...
static const int disp_mml_dl_exdma_path[] = {
...
static const int disp_ovlsys_0_to_1_exmda_path[] = {
	DDP_COMPONENT_OVLSYS_DLO_ASYNC1,
	DDP_COMPONENT_OVLSYS1_DLI_ASYNC2,
};

static const int disp_ovlsys_1_to_0_exmda_path[] = {
...
static const int disp_ovlsys_1_to_0_blender_path[] = {
...
static const struct mtk_addon_path_data addon_module_path[ADDON_MODULE_NUM] = {
		...
		[DISP_OVLSYS_0_1_EXDMA] = {
				.path = disp_ovlsys_0_to_1_exmda_path,
				.path_len = ARRAY_SIZE(disp_ovlsys_0_to_1_exmda_path),
			},
		[DISP_OVLSYS_1_0_EXDMA] = {
				.path = disp_ovlsys_1_to_0_exmda_path,
				.path_len = ARRAY_SIZE(disp_ovlsys_1_to_0_exmda_path),
			},
		[DISP_OVLSYS_1_0_BLENDER] = {
				.path = disp_ovlsys_1_to_0_blender_path,
				.path_len = ARRAY_SIZE(disp_ovlsys_1_to_0_blender_path),
			},
};
...

{
	...
	if (priv->data->mmsys_id == MMSYS_MT6768 ||
		...
		mtk_ddp_add_comp_to_path_with_cmdq(
			mtk_crtc, DDP_COMPONENT_OVL0, prev_id,
