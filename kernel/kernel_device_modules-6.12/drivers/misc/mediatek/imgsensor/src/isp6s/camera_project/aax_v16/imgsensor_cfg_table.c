...
struct IMGSENSOR_HW_CFG imgsensor_custom_config[] = {
	{
		...
		IMGSENSOR_I2C_DEV_0,
		{
			...
			{IMGSENSOR_HW_PIN_AVDD1, IMGSENSOR_HW_ID_REGULATOR}, //UW AVDD
			{IMGSENSOR_HW_PIN_DOVDD, IMGSENSOR_HW_ID_REGULATOR},
			{IMGSENSOR_HW_PIN_DVDD,  IMGSENSOR_HW_ID_REGULATOR},
			{IMGSENSOR_HW_PIN_DVDD1, IMGSENSOR_HW_ID_REGULATOR}, //UW DVDD
			{IMGSENSOR_HW_PIN_AFVDD, IMGSENSOR_HW_ID_REGULATOR},
			{IMGSENSOR_HW_PIN_RST,   IMGSENSOR_HW_ID_GPIO},
			{IMGSENSOR_HW_PIN_RST2,  IMGSENSOR_HW_ID_GPIO}, //UW Reset
...
struct IMGSENSOR_HW_POWER_SEQ sensor_power_sequence[] = {
	{
		...
		{
			{RST, Vol_Low, 0},
			//{RST2, Vol_Low, 1}, //remove control for UW stabilization
			{DOVDD, Vol_1800, 1},
			{DVDD, Vol_1050, 0},
			{DVDD1, Vol_1200, 1},
			{AFVDD, Vol_2800, 1},
