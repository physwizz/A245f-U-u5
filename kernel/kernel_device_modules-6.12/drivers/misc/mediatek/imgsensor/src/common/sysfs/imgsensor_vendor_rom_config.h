...
#elif defined(CONFIG_CAMERA_AAX_V16)
#include "./aax_v16/imgsensor_vendor_rom_config_aax_v16.h"
#elif defined(CONFIG_CAMERA_AAY_V17)
#include "./aay_v17/imgsensor_vendor_rom_config_aay_v17.h"
#else
//default
