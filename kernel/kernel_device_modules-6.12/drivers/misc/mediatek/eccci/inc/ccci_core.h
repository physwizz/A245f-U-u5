...
enum CCCI_CH {
	...
	CCCI_MIPC10_CHANNEL_RX  = 248,
	CCCI_MIPC10_CHANNEL_TX  = 249,

	/* NAD test */
	CCCI_AT_RX		= 258,
	CCCI_AT_TX		= 259,

	CCCI_IDC_WIFI_CHANNEL_RX= 266,
	CCCI_IDC_WIFI_CHANNEL_TX= 267,
	CCCI_IDC_BT_CHANNEL_RX	= 268,
	CCCI_IDC_BT_CHANNEL_TX	= 269,
	...
	/* increase ccmni to 30, so increase channels */
	CCCI_CCMNI22_RX,
	CCCI_CCMNI22_TX,
	CCCI_CCMNI23_RX,
	CCCI_CCMNI23_TX,
