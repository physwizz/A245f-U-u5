...
#if IS_ENABLED(CONFIG_SAMSUNG_TUI_LOWLEVEL)
#include "iwd_agent.h"
...
#if !IS_ENABLED(CONFIG_SOC_S5E9925) && !IS_ENABLED(CONFIG_SOC_S5E8825) && !IS_ENABLED(CONFIG_ARCH_HAS_SETUP_DMA_OPS)
...
static const struct of_device_id teegris_tui_of_match_table[] = {
	{ .compatible = "mediatek,samsung-tui", },
	{ },
};
